...
Every list endpoint is paginated — a shop accumulates articles and orders for as
long as it runs, and one unbounded response would take a replica down with it.
